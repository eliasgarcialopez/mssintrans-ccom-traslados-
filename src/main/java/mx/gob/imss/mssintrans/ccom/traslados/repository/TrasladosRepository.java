...
public interface TrasladosRepository extends JpaRepository<TrasladosEntity, Integer> {
	...
	@Query(value = ""
			+ "SELECT	SST.*,SAS.NOM_UNIDAD_ADSCRIPCION AS NOM_UNIDAD_SOLICITANTE,SAA.NOM_UNIDAD_ADSCRIPCION AS NOM_UNIDAD_ADSCRIPCION,SCP.CVE_COD_POSTAL AS CVE_COD_POSTAL, SM.NOM_MUNICIPIO AS NOM_MUNICIPIO, SE.ID_ENTIDAD AS ID_ENTIDAD, SE.NOM_ENTIDAD AS NOM_ENTIDAD, SDR.NOMBRE_DOCTOR AS NOMBRE_DOCTOR_RECIBE, SDA.NOMBRE_DOCTOR AS NOMBRE_DOCTOR_AUTORIZA																 "
			...
			+ "LEFT  	JOIN SINTRANST_CENSO_DOCTORES SDR ON SDR.MATRICULA_DOCTOR = SST.NUM_MATRICULA_DOCTOR_RECIBE                                  "			
			+ "LEFT  	JOIN SINTRANST_CENSO_DOCTORES SDA ON SDA.MATRICULA_DOCTOR = SST.NUM_MATRICULA_DOCTOR_AUTORIZA                                  "			
	...
	@Query(value = ""
			+ "SELECT	DISTINCT SST.*,SAS.NOM_UNIDAD_ADSCRIPCION AS NOM_UNIDAD_SOLICITANTE,SAA.NOM_UNIDAD_ADSCRIPCION AS NOM_UNIDAD_ADSCRIPCION,SCP.CVE_COD_POSTAL AS CVE_COD_POSTAL, SM.NOM_MUNICIPIO AS NOM_MUNICIPIO, SE.ID_ENTIDAD AS ID_ENTIDAD, SE.NOM_ENTIDAD AS NOM_ENTIDAD, SDR.NOMBRE_DOCTOR AS NOMBRE_DOCTOR_RECIBE, SDA.NOMBRE_DOCTOR AS NOMBRE_DOCTOR_AUTORIZA																 "
			+ "FROM		SINTRANST_SOLICITUD_TRASLADO SST   									 "
			+ "INNER 	JOIN SINTRANSC_UNIDADES_ADSCRIPCION SAS ON SAS.ID_UNIDAD_ADSCRIPCION = SST.ID_UNIDAD_SOLICITANTE     "			
			+ "INNER 	JOIN SINTRANSC_UNIDADES_ADSCRIPCION SAA ON SAA.ID_UNIDAD_ADSCRIPCION = SST.ID_UNIDAD_ADSCRIPCION     "			
			+ "LEFT 	JOIN SINTRANSC_CODIGO_POSTAL SCP ON SCP.ID_CODIGO_POSTAL = SST.ID_CODIGO_POSTAL                     "			
