...
public class DoctoresController {
	...
	public ResponseEntity<?> obtenerCensoDoctores(@RequestParam(defaultValue = "0") Integer pagina,
			...
			@RequestParam(defaultValue = "ASC") String orden, @RequestParam(required = false) String matricula) {
		Respuesta<?> response;
		...
		response = cenDocService.obtenerCensoDoctores(pageable, matricula,  datosUsuarios);
